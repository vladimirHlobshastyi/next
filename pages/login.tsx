...
const Login = () => {
    ...
    const onSubmit = useCallback((data: { login: string; password: string }) => {
        ...
        <div className={style.container}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    ...
                    <input type="text" placeholder="логин &rarr; user" id="login" {...register("login", { required: true })} />
                ...
                <div className={style.error}>{errorAuth.isError && (isLoginFailed ? <span>Не верный логин или пароль</span> : <span>Логинизация не удалась... пожалуйста попробуйте позже</span>)}</div>
