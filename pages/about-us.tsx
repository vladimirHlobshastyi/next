...
const About = () => {
  return (
    <div className={style.aboutContainer}>
      ...
      <span>
        <h4>
          Интернет-магазин &quot;MyShop.ru&quot; – лучшие товары по низким
          ценам!
        </h4>
      </span>
      ...
      <span>
        Магазин &quot;MyShop.ru&quot; предлагает Вам купить качественную и
        доступную технику, электронику, одежду, обувь, игрушки, книги и многое
        другое с доставкой! Все виды современных товаров от эконом класса до
        более дорогих представлены в нашем каталоге.
      </span>
      ...
      <span>
        Низкие цены от производителей Доставка по городу в день заказа Доставка
        заказов Почтой по всей Стране за 5-15 дней Только оригинальная и
