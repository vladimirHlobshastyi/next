...
const Contacts = () => {
  return (
    <div className={style.contactsContainer}>
      ...
      <span>
        Разместите на этой странице информацию с контактами вашего интернет-магазина, а также
      ...
      <span>
        Как добраться: Сокольническая линия метро, последний вагон из центра, выход в сторону
        Казанского вокзала.
      </span>
      ...
      <span>
        Понедельник с 9:00 до 21:00 Вторник с 9:00 до 21:00 Среда с 9:00 до 21:00 Четверг с 9:00 до
        21:00 Пятница с 9:00 до 21:00 Суббота с 10:00 до 20:00 Воскресенье с 10:00 до 20:00 Заказы
        через сайт принимаются круглосуточно!
      </span>
