...
const Contacts = () => {
    return <div className={style.contactsContainer}>
      ...
      />
        ...
        <span><h4>Например:</h4></span>

        <span>----</span>

        <span>Вы можете найти нас по адресу: г.Киев, ул.Барабулица 100</span>

        <span>Как добраться: Сокольническая линия метро, последний вагон из центра, выход в сторону Казанского вокзала.</span>
        ...
        <span>Подробнее о создании текстовых страниц и меню, читайте в документации: <Link href='https://google.com'>https://google.com</Link></span>
    </div>
}
